...
class XY {
    ...
    void moveTowards(XY other, float dist) { moveTowards(other.x, other.y, dist); }
    void moveTowards(float _x, float _y, float dist) { 
        //https://stackoverflow.com/a/5995931
        //at this point should I just switch to PVectors?
        float a = angle(_x, _y);
        y += sin(a) * dist;
        x += cos(a) * dist;
    }
