...
class Laserbolt implements Kid {
    ...
    void newTarget(float x, float y) {
        ...
        for (int i = 0; i < numPoints; i++) {
            inline = new XY(inline.x + segDist * anchor1.angCos(anchor0), inline.y + segDist * anchor1.angSin(anchor0));
            //inline = new XY(inline.x - segmentLength.value * anchor1.angCos(anchor0), inline.y - segmentLength.value * anchor1.angSin(anchor0));
